...
public class Int_Adm_Adm extends javax.swing.JFrame {
        ...
        try {
            ...
            for (Cliente cl : c) {
                if (cl.getAdm() && !cl.getAdmPrinc()) {
                    modelo.addRow(new Object[]{cl.getNome(), cl.getLogin(), cl.getEndereco(), cl.getCep(), cl.getIdCliente()});
                }
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Login", "Endereço", "CEP", "Id ADM"
            }
        ) {
        ...
        jMenu2.setText("Editar Produtos");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            if (c != null) {
                dispose();
                Int_AddAdm.Main_2nd(false, clt, c);
            } else {
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        try {
            dispose();
            Int_AddAdm.Main_2nd(true, clt, null);
        } catch (Exception prod) {
            JOptionPane.showMessageDialog(null, "Erro: " + prod);
        }
    ...
    public static void Main_2nd(final Cliente Logado) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Int_Adm_Adm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Int_Adm_Adm(Logado).setVisible(true);
            }
        });
    }
