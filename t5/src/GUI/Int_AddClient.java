 ...
 * @author TheTolfo
 */
public class Int_AddClient extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Int_AddClient
     */
    public Int_AddClient(boolean add, Cliente Logado, Cliente Edit) {
        initComponents();
        setLocationRelativeTo(null);
        if (add) {
            setTitle("InterVendas - ADM Adicionar Cliente");
        } else {
            setTitle("InterVendas - ADM Editar Cliente");
        }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        try {
            ...
            if (ok) {
                ...
                String str;
                if (Add) {
                    Cliente novo = new Cliente(jTextField2.getText(), "123456", "123456", jTextField1.getText(), jTextField3.getText(), jTextField4.getText(), 0, false, false);
                    s.save(novo);
    ...
    public static void Main_2nd(final boolean add, final Cliente Logado, final Cliente Edit) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Int_AddClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Int_AddClient(add, Logado, Edit).setVisible(true);
            }
        });
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Int_AddClient(true, null, null).setVisible(true);
            }
        });
    }
