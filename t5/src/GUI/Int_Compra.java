 ...
 * @author TheTolfo
 */
public class Int_Compra extends javax.swing.JFrame {

    /**
     * Creates new form Int_Compra
     */
    public Int_Compra() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Int_Compra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Int_Compra().setVisible(true);
            }
        });
    }
